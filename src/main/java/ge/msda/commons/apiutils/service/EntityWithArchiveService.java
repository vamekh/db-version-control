...
import ge.msda.commons.apiutils.entities.EntityWithArchive;
import ge.msda.commons.apiutils.repository.EntityWithArchiveRepository;
...
public class EntityWithArchiveService {
    ...
    public <R extends EntityWithArchiveRepository<T, ID>, T extends EntityWithArchive<ID>, ID extends Serializable> List<T> save(List<T> newObjects, R repo, Date actionDate) throws ResponseObject {
    ...
    public <R extends EntityWithArchiveRepository<T, ID>, T extends EntityWithArchive<ID>, ID extends Serializable> List<T> save(List<T> newObjects, R repo) throws ResponseObject {
        return save(newObjects, repo, new Date());
    }

    public <R extends EntityWithArchiveRepository<T, ID>, T extends EntityWithArchive<ID>, ID extends Serializable> T save(T newObject, R repo) throws ResponseObject {
        return save(newObject, repo, new Date());
    }

    public <R extends EntityWithArchiveRepository<T, ID>, T extends EntityWithArchive<ID>, ID extends Serializable> T save(T newObject, R repo, Date actionDate) throws ResponseObject {
