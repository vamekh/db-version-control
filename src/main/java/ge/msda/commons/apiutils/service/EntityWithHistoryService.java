package ge.msda.commons.apiutils.service;

import ge.msda.clients.errorservice.ErrorService;
import ge.msda.commons.apiutils.entities.EntityWithHistory;
import ge.msda.commons.apiutils.repository.EntityWithHistoryRepository;
...
public class EntityWithHistoryService {
    ...
    @Transactional
    public <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> List<T> save(T newObject, R repo) throws ResponseObject {
    ...
    private <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> void insert(T newObject, R repo, List<? super T> container) throws ResponseObject {
        newObject.setRecordState(1);
    ...
    private <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> void update(T newObject, R repo, List<? super T> container) throws ResponseObject {
    ...
    private <T extends EntityWithHistory, R extends EntityWithHistoryRepository<T, Long>> void manageAround(T newObject, R repo, T aroundInstance, List<? super T> container) throws ResponseObject {
    ...
    private <T extends EntityWithHistory, R extends EntityWithHistoryRepository<T, Long>> void manageMiddle(T newObject, R repo, List<? super T> container) throws ResponseObject {
    ...
    private <T extends EntityWithHistory, R extends EntityWithHistoryRepository<T, Long>> void manageRight(T newObject, R repo, List<? super T> container) throws ResponseObject {
    ...
    private <T extends EntityWithHistory, R extends EntityWithHistoryRepository<T, Long>> void manageLeft(T newObject, R repo, List<? super T> container) throws ResponseObject {
    ...
    public <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> T delete(Long id, Date deleteFromDate, R repo) throws ResponseObject {
        try {
    ...
    public <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> void delete(Long id, R repo) throws ResponseObject {
        delete(id, new Date(), repo);
    }

    public <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> void delete(T objectToDelete, R repo) throws ResponseObject {
        delete(objectToDelete.getId(), new Date(), repo);
    }

    public <R extends EntityWithHistoryRepository<T, Long>, T extends EntityWithHistory> void delete(T objectToDelete, Date deleteFromDate, R repo) throws ResponseObject {
