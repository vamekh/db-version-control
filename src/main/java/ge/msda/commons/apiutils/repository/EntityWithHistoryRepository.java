package ge.msda.commons.apiutils.repository;
...
@NoRepositoryBean
public interface EntityWithHistoryRepository<T extends EntityWithHistory, ID extends Serializable> extends JpaRepository<T, ID> {
